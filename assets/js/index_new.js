...
copyBtn.addEventListener("click", () => {
    ...
    document.getElementById("tateardionomics-address").select();
    document.execCommand("copy");

    document.activeElement.blur();

    copyMsg.classList.add("tateardionomics__main-tag-msg_active");
    setTimeout(() => {
        copyMsg.classList.remove("tateardionomics__main-tag-msg_active");
    }, 3000);
});
